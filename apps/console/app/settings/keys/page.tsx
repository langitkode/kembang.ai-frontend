            ...
            <CardContent>
              {loading ? (
                ...
                <div className="p-12 text-center space-y-4">
                  <div className="w-14 h-14 rounded-full bg-muted/30 border mx-auto flex items-center justify-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-muted border rounded-lg font-mono text-xs">
            ...
            <CardContent className="space-y-3">
              {[
                ...
                >
                  ...
                  <div
                    className={`w-2 h-2 rounded-full ${scope.access ? "bg-accent shadow-[0_0_4px_rgba(100,100,255,0.5)]" : "bg-muted"}`}
                  />
                </div>
              ))}
            </CardContent>
