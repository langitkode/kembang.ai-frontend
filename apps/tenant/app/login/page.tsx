...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Tenant dashboard accepts both 'admin' and 'superadmin' roles
      if (user.role === "superadmin") {
        toast.info("Superadmin detected. Redirecting to Console...");
        router.push("/"); // Superadmin should use console
        return;
      }
